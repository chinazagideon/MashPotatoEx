                        ...
                        <div class="row d-flex flex-wrap align-items-center">
                            <div class="lqd-column col-md-6 col-md-offset-1">
                                <header class="fancy-title">
                                    ...
                                    <p>Welcome Back, Create a new email and password to continue</p>
                                </header>
                            </div>
                        ...
                        <div class="row">
                            <div class="lqd-column col-md-6 col-md-offset-3">
                                <div class="contact-form contact-form-inputs-underlined contact-form-button-circle">
                                    ...
                                    <br/>
                                    <br/>
                                    <form action="{{route('recover_password_change')}}" method="post">
                                        @csrf
                                        <div class="row d-flex flex-wrap">
                                            <div class="lqd-column col-md-12 mb-20">
                                                ...
                                                <input class="lh-25 mb-30" type="email" name="email"
                                                       ...
                                                       placeholder="Enter a valid email address" value="{{!empty(old('email')) ? old('email') : $email }}" required autofocus>
                                                @error('email')
                                        ...
                                        <strong>{{ $message }}</strong>
                                                ...
                                                <input class="lh-25 mb-30" type="password" name="password"
                                                       aria-required="true"
                                                       aria-invalid="false" placeholder="Create a new password" required>
                                                @error('password')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
