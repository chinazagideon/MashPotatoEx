            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @if(empty($data['user']->passwordSecurity->google2fa_secret))
...
<strong>{{ $errors->first('current-password') }}</strong>
    ...
    {{--<script>--}}
        {{--function validate2fa(){--}}
            {{--var verify_code = $("[name=verify-code]").val();--}}
            {{--var post_url = $("[name=post_url]").val();--}}
            {{--var token = $("[name=_token]").val();--}}
            {{--var dataToSend = "verify-code="+verify_code+"&_token="+token;--}}
        {{--$.ajax({--}}
            {{--url: post_url,--}}
            {{--type: 'POST',--}}
            {{--data: dataToSend,--}}
