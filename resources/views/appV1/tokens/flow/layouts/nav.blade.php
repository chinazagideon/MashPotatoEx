@extends('appV1.tokens.qredo.layouts.app')
@section('header')
    <nav class="navbar" id="myNavbar">
        ...
        <div class="container ">
            ...
            <div class="navbar-header ">
                ...
                <a href="/" class="site-logo navbar-brand"><img src="{{asset('appV1/assets/img/misc/logo-ave-2.png')}}" alt="{{config('app.name')}}'s Logo" style="width: 50%;" class="img-responsive"></a><!-- main logo -->
            </div>
...
@section('footer')
    ...
    <div class="lqd-sticky-footer-wrap pt5"
        ...
        <footer class="main-footer pt-100 pt-70 footer-stuck is-inview">
            <section class="pt-5" style="padding-top: 50px;">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="lqd-column col-md-6 col-sm-6"
                            ...
                            <div class="">
                                <p class="" style="font-size: 11px !important; ">
