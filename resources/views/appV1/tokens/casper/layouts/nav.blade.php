@extends('appV1.tokens.casper.layouts.app')
@section('header')
    <header class="sticktop s3">
        <div class="menusec">
            <div class="logo"> <a href="/" title="">
                    <img class="hidec" src="{{asset('appV1/assets/img/misc/logo-ave.png')}}" style="width: 100%" alt="" />
                    <img class="showc" src="{{asset('appV1/assets/img/misc/logo-ave-2.png')}}" style="width: 100%" alt="" />
                </a>
            </div>
            <div class="social">
{{--                <a href="index3.html#" title=""><i class="fa fa-facebook"></i></a>--}}
{{--                <a href="index3.html#" title=""><i class="fa fa-twitter"></i></a>--}}
{{--                <a href="index3.html#" title=""><i class="fa fa-youtube"></i></a>--}}
{{--                <a href="index3.html#" title=""><i class="fa fa-instagram"></i></a>--}}
{{--                <a href="index3.html#" title=""><i class="fa fa-github"></i></a>--}}
{{--                <a href="index3.html#" title=""><i class="fa fa-bitcoin"></i></a>--}}
            </div>
            <div class="apps-btns">
                <a href="{{route('register')}}" class="g2" title="">Register</a>
            </div>
...
@section('footer')
    ...
    <div class=""
         style="line-height: 1.4em !important;background-color: #f9f9f96e !important;">
        <div class="height-applied"></div>
        <footer class="main-footer pt-100 pt-70 footer-stuck is-inview" >
            <section class="pt-5" style="padding-top: 50px;!important;background-color: #f9f9f96e !important;">
                <div class="container" >

                    <div class="row">
                        <div class="lqd-column col-md-6 col-sm-6">
                            <p class="s-marginBottom0_5"
                               style="font-size: 11px !important; color: rgba(0,0,0,0.3) !important;line-height: 1.4em">
                        ...
                        <div class="lqd-column col-md-6 col-sm-6"
                             style="color: rgba(0,0,0,0.3) !important; ">
                            <div class="">
                                <p class="" style="font-size: 11px !important; line-height: 1.4em;color: rgba(0,0,0,0.3) !important;">
                    ...
                    <div class="row">
                        ...
                        <div class="lqd-column col-md-6 text-md-left pt-5" style="font-size: 16px !important; padding-top: 50px">
                            <p>
