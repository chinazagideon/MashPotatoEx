...
@section('header')
    ...
    @if(request()->segment(1) === '' && empty(request()->segment(1)))
        <header class="main-header main-header-overlay"
                style="background-image: linear-gradient(0deg, #07036c, transparent 25%),radial-gradient(at 50% 330px, #0b0a6a, #010057);">
            @else
                <header class="main-header main-header-overlay">
                    @endif
                                ...
                                <div class="row mainbar-row align-items-lg-stretch px-4">
                                    <div class="col">
                                        <div class="navbar-header">
                                            <a class="navbar-brand pt-10 pb-35" href="/" rel="home">
<span class="navbar-brand-inner">
<img class="logo-dark" src="{{asset('appV1/assets/img/misc/logo-ave-2.png')}}" alt="{{config('app.name')}}"  style="width: 100%">
<img class="logo-sticky" src="{{asset('appV1/assets/img/misc/logo-ave-1.png')}}" alt="{{config('app.name')}}">
<img class="mobile-logo-default" src="{{asset('appV1/assets/img/misc/logo-ave-2.png')}}" alt="{{config('app.name')}}" style="width: 100%">
<img class="logo-default" src="{{asset('appV1/assets/img/misc/logo-ave-1.png')}}" alt="{{config('app.name')}}">
</span>
                                            </a>
                                            <button type="button"
                                    ...
                                    <div class="col">
                                        <div class="collapse navbar-collapse" id="main-header-collapse">
                                            <ul id="primary-nav"
                                                ...
                                                <li class=" {{request()->segment(1) == "" ? 'is-active' : ''}}">
                                                    <a href="/">
...
<span class="txt">Home</span>
                                                ...
                                                <li class="{{request()->segment(1) == "market-data" ? 'is-active' : ''}}">
                                                    <a href="{{route('market_data')}}">
                                                        <span class="link-icon"></span>
                                                        <span class="link-txt">
<span class="link-ext"></span>
<span class="txt">Market Data</span>
                                                ...
                                                <li class="{{request()->segment(1) == "products" ? 'is-active' : ''}}">
...
<span class="txt">Products</span>
                                                ...
                                                <li class="{{request()->segment(1) == "token" ? 'is-active' : ''}}">
                                                    <a href="{{route('sales')}}">
                                                        <span class="link-icon"></span>
                                                        <span class="link-txt">
<span class="link-ext"></span>
<span class="txt">Token Sales</span>
                                                ...
                                                <li class="{{request()->segment(1) == "mining" ? 'is-active' : ''}}">
                                                    <a href="{{route('mining')}}">
                                                        <span class="link-icon"></span>
                                                        <span class="link-txt">
<span class="link-ext"></span>
...
<span class="btn-txt">Get Started</span>
                ...
                @if(request()->segment(1) === '' && empty(request()->segment(1)))
                    <section class="vc_row py-5 d-flex flex-wrap align-items-center bg-cover"
                             style="background-image: linear-gradient(0deg, #07036c, transparent 25%),radial-gradient(at 50% 330px, #0b0a6a, #010057);"></section>
                @else
                        ...
                        <section class="pb-55">
                            <div class="container">
                                    ...
                                    <div class="lqd-column col-md-6 col-sm-6">
                                        ...
                                        <p class="s-marginBottom0_5"
                                           style="font-size: 11px !important; color: rgba(0,0,0,0.3) !important; ">
                                            ...
                                            professionals on
                                            <a class="" target="_blank" href="https://brokercheck.finra.org/firm/summary/309708">FINRA’s
                                        ...
                                        <div class="s-grid-colSm10 s-fontSize11">
                                            ...
                                            <p class="s-marginBottom0_5">
                                                All activities on this site are governed by our <a class=""
                                                                                                   href="{{asset('appV1/assets/documents/PennHaven_Terms_and_Conditions.pdf')}}" target="_blank">Terms
                                                    of
                                                    Service</a> and
                                ...
                                <div class="row">
                                    ...
                                    <div class="lqd-column col-md-5 text-sm-left text-xl-center  pt-5 " style="font-size: 16px !important;line-height: 40px; font-weight: 400;">
                                        <p>
...
{{--                                                    class="fa fa-skype"></i></a>--}}
                                    ...
                                    <div class="col-md-1 lqd-column text-center">
                                    </div>
                                    <div class="col-md-3 lqd-column text-center">
                                    </div>
                                    <div class="col-md-3 lqd-column text-center">
